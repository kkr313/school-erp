      ...
      <Paper
        ...
        sx={{
          ...
          "&::before": {
            ...
            backgroundPosition: "-200px 0",            opacity: 0,
      ...
      >        {/* Gradient orb background */}
        ...
        <Box
          sx={{
            ...
            border: `2px solid ${color}20`,            transition: "all 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
            animation: isHovered ? `${floatAnimation} 8s ease-in-out infinite` : "none",
        ...
        >          <Box 
            sx={{ 
              ...
              color: color,              transition: "all 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
        ...
        {/* Text content */}
        <Box sx={{ position: "relative", zIndex: 2, px: 1 }}>          <Typography 
            variant="subtitle1" 
            sx={{
              fontWeight: 600,
              ...
              lineHeight: 1.3,
              mb: description ? 0.5 : 0,              transition: "all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
          ...
          >
            ...
            <Typography 
              ...
              sx={{
                ...
                fontSize: "0.75rem",
                opacity: isHovered ? 1 : 0.7,                transition: "all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
                transform: isHovered ? "translateY(-1px) scale(1.01)" : "translateY(0px) scale(1)",
              }}
            >
              {description}
        ...
        <Box
          sx={{
            ...
            inset: 0,
            borderRadius: 4,
            background: `radial-gradient(circle at center, ${color}25, transparent 70%)`,            opacity: isHovered ? 0.3 : 0,
            transition: "all 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
