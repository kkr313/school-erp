    ...
    setMarksData((prev) => {
      ...
      if (checked) {
        if (!updated[subjectCode]) {
          updated[subjectCode] = { fullMarks: "", passMarks: "", selected: true, error: "" };
        } else {
    ...
    setMarksData((prev) => {
      ...
      if (field === "passMarks") {
        ...
        if (pass > full) {
          ...
          updated[subjectCode].error = "Pass Marks must be less than or equal to Full Marks";
          return updated;
        } else {
                ...
                <TableRow>
                  <TableCell>
                    <Checkbox
                      ...
                      checked={
                        subjects.length > 0 &&
                        subjects.every((subj) => marksData[subj.subjectCode]?.selected)
                      }
                      indeterminate={
                        subjects.some((subj) => marksData[subj.subjectCode]?.selected) &&
                        !subjects.every((subj) => marksData[subj.subjectCode]?.selected)
                      }
                      onChange={(e) => {
                  ...
                  <TableRow key={subj.subjectCode}>
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          handleCheckboxChange(subj.subjectCode, e.target.checked)
                        }
                      />
                    </TableCell>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        onChange={(e) =>
                          handleMarksChange(subj.subjectCode, "fullMarks", e.target.value)
                        }
