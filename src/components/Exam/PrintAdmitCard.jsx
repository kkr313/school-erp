  ...
  return (
    <Box p={3}>
      ...
      <TextField
        ...
        helperText={showAttempted && !selectedExam ? "Please select an exam" : ""}
      >
        {exams.map((exam) => (
      ...
      <Class
        ...
        helperText={showAttempted && !selectedClass ? "Please select a class" : ""}
      />
        ...
        declaration ? (
          <Paper sx={{ mt: 3, p: 2 }}>
            <Typography variant="h6" gutterBottom>
              Admit Card - Exam {exams.find(e => e.id === displayExam)?.examName}, Class {displayClass?.label}
            </Typography>
                ...
                {declaration.subjects.map((subj, idx) => {
                  ...
                  return (
                    <TableRow key={idx}>
                      ...
                      <TableCell>{formatTime(subj.fromTime)} – {formatTime(subj.toTime)}</TableCell>
                    </TableRow>
                  );
                })}
              </TableBody>
      ...
      {loadingStudents ? (
        ...
        declaration && (
          <Paper sx={{ mt: 3, p: 2 }}>
            <Typography variant="h6" gutterBottom>
              Students List - Class {displayClass?.label}, Section {displaySection}
            </Typography>
      ...
      {printMode && selectedStudents.length > 0 && (
        <div ref={printRef}>
          <AdmitCardPrintView
            students={students.filter((s) => selectedStudents.includes(s.admissionNo))}
