          ...
          >
            ...
            <div
              className={`grid grid-cols-2 gap-y-1 ${
                billsPerPage === 9 ? 'mt-0 mb-0' : 'mt-2 mb-2'
              }`}
            >
              {billsPerPage === 9 ||
              billsPerPage === 2 ||
            ...
            {billsPerPage !== 9 && billsPerPage !== 6 && (
              <>
                ...
                <p className='mt-1'>
                  <strong>Description:</strong> {student.duesDescription}
                </p>
              </>
            )}
            ...
            {billsPerPage === 9 && (
              <div className='mt-2 border border-black p-2'>
                <p>
                  ...
                  {normalFees.reduce((sum, f) => sum + (f.feeAmount || 0), 0)} |{' '}
