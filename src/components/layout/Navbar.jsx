        ...
        <div className='hidden md:flex items-center justify-center h-16 navbar-height'>
          ...
          <div className='flex items-center justify-center w-full max-w-2xl'>
            <div className='relative w-full max-w-md'>
              <BiSearch className='absolute top-1/2 left-4 transform -translate-y-1/2 text-xl text-gray-400 group-focus-within:text-blue-500 transition-colors duration-300 cursor-pointer' />{' '}
              <input
                type='text'
          ...
          {/* Desktop Action Buttons - Positioned to the right */}
          <div className='absolute right-4 flex items-center gap-3'>
            ...
            <div className='relative dropdown-container'>
              ...
              >
                ...
                <IoIosArrowDown
                  className={`text-sm text-gray-500 transition-transform duration-200 ${dropdownOpen ? 'rotate-180' : ''}`}
                />
              </button>
            </div>
          </div>
