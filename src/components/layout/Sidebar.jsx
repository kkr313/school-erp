  ...
  return (
    <>
      ...
      >
        {/* Header Section */}
        <div
          className={`border-b border-white/10 ${collapsed ? 'p-2' : 'p-4'}`}
        >
          {!collapsed && (
              ...
              <div className='relative group'>
                ...
                <div className='relative bg-white/90 backdrop-blur-sm rounded-lg p-1.5 border border-white/20 shadow-lg'>
                  <img
                    src={logo}
                    alt='School Logo'
                    className='h-9 w-9 object-contain animate-float'
                  />
                </div>
              </div>
            </div>
        ...
        {/* Menu Items */}
        <div
          className={`flex-1 overflow-y-auto py-4 min-h-0 ${collapsed ? 'no-scrollbar' : 'custom-scrollbar'} max-h-[calc(100vh-200px)]`}
        >
          {/* Main Menu Items */}
        ...
        {/* Enhanced Toggle Button - bottom attached, arrow always visible and prominent */}{' '}
        <div className='hidden md:flex absolute bottom-4 right-0 z-50'>
          <button
