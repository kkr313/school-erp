...
const HeaderPDF = ({ overrideStyle }) => {
  ...
  const appliedStyle = {
    printHeaderFontColor: overrideStyle?.printHeaderFontColor || theme.printHeaderFontColor,
    printHeaderFontFamily: overrideStyle?.printHeaderFontFamily || theme.printHeaderFontFamily,
    printSubHeaderFontColor: overrideStyle?.printSubHeaderFontColor || theme.printSubHeaderFontColor,
    printSubHeaderFontFamily: overrideStyle?.printSubHeaderFontFamily || theme.printSubHeaderFontFamily,
    printHeaderStyle: overrideStyle?.printHeaderStyle || theme.printHeaderStyle || 'style1',
  };
...
const renderStyle4 = () => (
  <Box display="flex" alignItems="center" mb={2} borderBottom="2px solid #000" pb={1}>
    {renderLogo()}
    <Box flex={1} textAlign="center">
      ...
      >
        {school.email && <>Email: <b>{school.email}</b>{' '}</>} <br />
        {school.mobile && <>Mobile: <b>{school.mobile}</b>{' '}</>} <span>|</span>
        {school.website && <>Website: <b>{school.website}</b></>}
      </Typography>
    </Box>
  </Box>
);
