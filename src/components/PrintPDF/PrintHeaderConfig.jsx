...
const PrintHeaderConfig = () => {
  ...
  const handleConfirmed = () => {
    if (confirmDialog.action === 'save') {
      ...
      setTheme({
        ...
        printSubHeaderFontColor: defaultTheme.printSubHeaderFontColor || '#000000',
        printSubHeaderFontFamily: defaultTheme.printSubHeaderFontFamily || 'Poppins',
  ...
  const fontOptions = [
    'Poppins', 'Arial', 'Courier New', 'Verdana', 'Tahoma', 'Trebuchet MS',
    'Times New Roman', 'Georgia', 'Lucida Console', 'Segoe UI', 'Calibri',
    'Cambria', 'Garamond', 'Palatino Linotype', 'Impact', 'Comic Sans MS',
    'Franklin Gothic Medium', 'Century Gothic', 'Monaco', 'Constantia'
  ];
    ...
    <>
      ...
      >
        ...
        <Box mt={3} p={2} border="1px dashed grey" borderRadius={2}>
          ...
          <HeaderPDF overrideStyle={localConfig} /> {/* Pass localConfig for live preview */}
        </Box>
