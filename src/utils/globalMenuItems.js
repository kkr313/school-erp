...
export const menuItems = [
  ...
  { title: "Fee Collection", icon: FaIcons.FaRupeeSign, path: "/fee-collection" },
  { title: "Student Enquiry", icon: BsIcons.BsPersonLinesFill, path: "/student-enquiry" },
...
export const masterItems = [
  ...
  { title: "Employee Master", icon: FaIcons.FaUserTie, path: "/master/employee" },
  { title: "Fee Head Master", icon: FaIcons.FaRupeeSign, path: "/master/fee-head" },
];

export const attendanceItems = [
  { title: "Mark Attendance", icon: BsIcons.BsCalendarCheck, path: "/attendance/mark" },
  { title: "Attendance Report", icon: FaIcons.FaClipboardCheck, path: "/attendance/report" },
  { title: "Monthly Report", icon: IoStatsChartSharp, path: "/attendance/report-monthly" },
];
...
export const collectionItems = [
  ...
  { title: "Dues Management", icon: FiIcons.FiDollarSign, path: "/dues-collection" },
  { title: "Demand Bill", icon: FiIcons.FiFileText, path: "/demand-bill" },
];

export const reportItems = [
  { title: "Student Reports", icon: FaIcons.FaFileAlt, path: "/report/student-detail" },
  { title: "Fee Reports", icon: FiIcons.FiDollarSign, path: "/report/fee-collection" },
  { title: "Enquiry Reports", icon: FiIcons.FiUsers, path: "/report/student-enquiry" },
...
export const configItems = [
  ...
  { title: "Header Config", icon: FiIcons.FiFileText, path: "/configuration/header" },
];
